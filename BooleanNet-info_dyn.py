...
def main(args):
    ...
    Nbr_States = 4 # the number of all possible states of a node
    ...
    if 'primary_attractor' in timeSeries_Type:
        ...
        primary_attractor = attractors.keys()[1] #attractors is ordered with basin size from the function "find_attractor" and hence primary attractor is the first one.
    ...
    if 'one_trajectory' in timeSeries_Type:        ## 5-3. time series for one initial network state

        InitBiState = { 'Gov': 1, 'FirmA': 0, 'FirmB': 1, 'FirmC': 1, 'FirmD': 1, 'FirmE': 1, 'FirmF': 1, 'FirmG': 1, 'FirmH': 1,'FirmI': 1, 'FirmJ': 1, 'FirmK': 1, 'FirmL': 1, 'FirmM': 1, 'FirmN': 1 } # initial state for fission yeast
    ...
    if 'all_initial' in timeSeries_Type:
        ...
        ## 6-1-b. To compute TE
        result_te_all = open('C:/Boolean_Delay_in_Economics/Manny/Results/gov-te-all-step%d-trans0-h%d.dat'%(maxStep, historyLength),'w')
        ...
        result_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/gov-ai-all-scale-step%d-trans0-h%d.dat'%(maxStep, historyLength)
        viz_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/gov-ai-all-scale-step%d-trans0-h%d.pdf'%(maxStep, historyLength)
    ...
    if 'primary_attractor' in timeSeries_Type:
        ...
        ## 6-2-a. To compute AI
        result_ai_pa = open('C:/Boolean_Delay_in_Economics/Manny/Results/gov-ai-pa-step%d-trans0-h%d.dat'%(maxStep, historyLength),'w')
        AI_pa = {}
        for n in nodes_list:
        ...
        ## 6-2-b. To compute TE
        result_te_pa = open('C:/Boolean_Delay_in_Economics/Manny/Results/gov-te-pa-step%d-trans0-h%d.dat'%(maxStep, historyLength),'w')
        ...
        result_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/gov-ai-pa-scale-step%d-trans0-h%d.dat'%(maxStep, historyLength)
    ...
    if 'one_trajectory' in timeSeries_Type:
        ...
        for n in nodes_list:
            ...
            result_ai_one_.write('%s\t%f\n'%(n, AI_one[n]))

        ## 6-3-b. To compute TE
        result_te_one = open('C:/Boolean_Delay_in_Economics/Manny/Results/gov-te-one-step%d-trans0-h%d.dat'%(maxStep, historyLength),'w')
        ...
        result_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/gov-ai-one-scale-step%d-trans0-h%d.dat'%(maxStep, historyLength)
        viz_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/Gov_ActiveInformation-one-scale-step%d-trans0-h%d.pdf'%(maxStep, historyLength)
        ...
        result_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/gov-te-one-scale-step%d-trans0-h%d.dat'%(maxStep, historyLength)
        viz_file_name = 'C:/Boolean_Delay_in_Economics/Manny/Results/Gov_TransferEntropy-one-scale-step%d-trans0-h%d.pdf'%(maxStep, historyLength)
...
'''
    ...
    result_ai = open('C:/Boolean_Delay_in_Economics/Gov/Results/ai-step%d-trans0-h%d.dat'%(maxStep, historyLength),'w')
    result_te = open('C:/Boolean_Delay_in_Economics/Gov/Results/gov-te-step%d-trans0-h%d.dat'%(maxStep, historyLength),'w')
